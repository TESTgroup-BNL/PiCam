...
helperfunDIR <- file.path("/Volumes/data2/dyang/projects/ngee_arctic/seward/scripts/phenocam_processing/helperfuns_eos.R")
source(helperfunDIR)
#*****************************************************************************************#
...
tempDIR <- file.path(paste0(outDIR, "/", 'fall'))
...
expEND <- as.Date("2021/10/10") #"2022/07/24"
...
phenoFILE <- list.files(phenoDIR, pattern = "PiCam_029_20210817_20220304_roi2",
